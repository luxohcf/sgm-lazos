...
VALUES 
(1,'super-user','rol del super usuario',1,'luxo',curdate(),null);
...
VALUES 
(1,'Proyecto','',1,'luxo',curdate(),null,null,null),
(2,'Clientes','',1,'luxo',curdate(),null,null,null),
(3,'Registrar','proyecto.php',1,'luxo',curdate(),null,1,'css/images/registrar.jpg'),
(4,'Buscar','proyecto.php',1,'luxo',curdate(),null,1,'css/images/Search.png'),
(5,'Estadisticas','proyecto.php',1,'luxo',curdate(),null,1,'css/images/Estrella-blanca.png'),
(6,'Otroas','proyecto.php',1,'luxo',curdate(),null,1,'css/images/Estrella-blanca.png'),
(7,'Buscar','proyecto.php',1,'luxo',curdate(),null,2,'css/images/Search.png'),
(8,'Solicitudes','',1,'luxo',curdate(),null,null,null),
(9,'Buscar','proyecto.php',1,'luxo',curdate(),null,8,'css/images/Search.png');
