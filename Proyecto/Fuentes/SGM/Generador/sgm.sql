...
CREATE TABLE tsg_cliente (
  ...
  cli_fecha_ini datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'fecha de inicio del cliente',
...
CREATE TABLE tsg_proyecto (
  ...
  pro_fecha_ini datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Fecha inicio del proyecto',
...
CREATE TABLE tsg_ticket (
  ...
  tic_fecha_crea datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'fecha de creación del ticket',
  tsg_estado_ticketest_id int(10) NOT NULL,
  tsg_usuariousu_id int(10) NOT NULL,
  tsg_proyectopro_id int(10) NOT NULL,
  tsg_prioridadpri_id int(10) NOT NULL,
...
CREATE TABLE tsg_usuario (
  ...
  usu_fecha_crea datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Fecha de creación, se usara la secuencia de timestamp para guardar la hora y la fecha.',
